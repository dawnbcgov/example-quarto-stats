...
customMessage: Local air quality has improved due to changing
  meteorological conditions. Although the 24-hour concentration remains
  above the Air Quality Objective, the hourly concentrations have
...
March 06, 2026 for Golden due to elevated levels of coarse particulate
matter.

Local air quality has improved due to changing meteorological
conditions. Although the 24-hour concentration remains above the Air
Quality Objective, the hourly concentrations have returned to typical
levels.
...
::: {.table-responsive}
  ...
  ------------------------- -------- ----------- --------- ----------
  24-hr average (μg/m^3^)   50.7     11.5        4.7       8.5
